...
router.get('/userbox', async (req, res, next ) => {
    try {
...
//[POST] Recipe to userbox
router.post('/userbox/:id', validateRecipeID, async ( req, res, next ) => {
    try {
...
//REMOVE recipe from userbox

router.delete('/userbox/:id', validateRecipeID, async ( req, res, next ) => {
    try {
